...
const Details = () => {
  return (
    <div className="container mx-auto pt-5 bg-white shadow overflow-hidden sm:rounded-lg">
              ...
              <ul role="list" className="border border-gray-200 rounded-md divide-y divide-gray-200">
                <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                  <div className="w-0 flex-1 flex items-center">
                    <PaperClip />
                    <span className="pl-2 flex-1 w-0 truncate">resume_back_end_developer.pdf</span>
                  </div>
                ...
                <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                  <div className="w-0 flex-1 flex items-center">
                    <PaperClip />
                    <span className="pl-2 flex-1 w-0 truncate">coverletter_back_end_developer.pdf</span>
                  </div>
                  <div className="pl-4 flex-shrink-0">
                    <a href="#" className="font-medium text-indigo-600 hover:text-indigo-500">
                      Download
